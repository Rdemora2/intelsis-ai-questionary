...
const STEPS = [
  {
    label: "Analisando padrões operacionais…",
    icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
  },
  {
    label: "Mapeando soluções SAP aplicáveis…",
        ...
        {STEPS.map((step, index) => {
          ...
          return (
            ...
            >
              <div className="flex-shrink-0 h-8 w-8 rounded-lg flex items-center justify-center">
                {isDone ? (
                  ...
                  <div className="h-8 w-8 rounded-lg bg-brand-500/10 flex items-center justify-center">
                    <svg
                      className="h-4 w-4 text-brand-400 animate-pulse"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={1.5}
              ...
              <span
                className={`text-sm ${isDone ? "text-brand-400" : isCurrent ? "text-white font-medium" : "text-surface-600"}`}
              >
                {step.label}
              </span>
            </div>
